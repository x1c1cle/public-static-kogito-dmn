...
import org.rhett.CustomMessage;

import com.fasterxml.jackson.annotation.JsonIgnore;



public class DecisionDMNResult implements Serializable,
    ...
    //for Proof of concept,suppress. 
    @JsonIgnore
    public List<KogitoDMNMessage> messages = new ArrayList<>();

    //Custom Message list. 
    public List<CustomMessage> customMessages = new ArrayList<>();

    private Map<String, KogitoDMNDecisionResult> decisionResults = new HashMap<>();

    public DecisionDMNResult() {
        // Intentionally blank.
    }

    public DecisionDMNResult(String namespace, String modelName, org.kie.dmn.api.core.DMNResult dmnResult) {
